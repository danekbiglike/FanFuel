...
### Цифровые аккаунты и доступ

- Не хранить и не передавать через FanFuel пароли, recovery codes, session cookies, API keys или raw 2FA secrets.
- Заявление продавца о личном владении не заменяет проверку происхождения и права передачи по правилам исходной платформы.
- Украденные, взломанные, восстановленные у третьих лиц, shared и promo-abuse аккаунты запрещены.
- Аккаунт с неудалёнными персональными данными, перепиской, файлами или платёжными реквизитами нельзя публиковать и передавать.
- Способ исполнения должен позволять сменить разрешённые contact/recovery factors без раскрытия секретов сотрудникам FanFuel.
- Для каждой разрешаемой подкатегории нужны отдельные признаки риска, evidence policy, moderation checklist и incident/revocation flow.
