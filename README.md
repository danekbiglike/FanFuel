...
Тестовая статическая главная с интерактивным карандашным Ойли: `https://playground.fanfuel.ru/`. Исходники и порядок разработки — [docs/PLAYGROUND.md](docs/PLAYGROUND.md). Основной сайт остаётся на `https://fanfuel.ru/`.

FanFuel — marketplace цифровых товаров с creator-commerce механиками для покупателей, авторов и продавцов. Он объединяет обычные цифровые покупки, поддержку любимых авторов, донаты, OBS-алерты, витрины, промокоды и партнёрские рекомендации.

Главная идея: зритель может не только задонатить, но и купить что-то полезное, одновременно поддержав любимого автора.

## Позиционирование

FanFuel — цифровые товары, безопасная покупка и поддержка любимых авторов в одной платформе. Главная точка входа — marketplace для обычного покупателя; товары для стримеров и авторов важны, но не ограничивают ассортимент.
...
- **FanFuel Market** — общий маркетплейс цифровых товаров и услуг; OBS-паки, алерты, виджеты и creator assets являются отдельными направлениями, а не границей всего каталога.
...
- [docs/roadmap/experience-brand-world.md](docs/roadmap/experience-brand-world.md)
