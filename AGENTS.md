...
В пользовательском интерфейсе и текстах FanFuel запрещены звездочки и стрелки как Unicode-символы, эмодзи или декоративные пиктограммы: на iPhone они отображаются нестабильно и выглядят как шаблонный текст. Если нужна иконка или направление, использовать существующую иконку проекта без звездной или стрелочной формы либо явно подписанное действие. Писать естественно и конкретно, избегать шаблонных оборотов, чрезмерных украшений и других узнаваемых признаков автоматически сгенерированного текста. Подробности — в `docs/UI_RULES.md` и `docs/UX_WRITING.md`.
