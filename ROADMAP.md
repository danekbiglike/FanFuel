...
- Сначала откройте [текущий практический фокус](docs/roadmap/current-focus.md).
- Затем откройте только нужный этап из списка ниже.
- Общие правила планирования лежат в [принципах roadmap](docs/roadmap/principles.md).
